...
public class Calculator {
    ...
    private static boolean numberChar(Character c, boolean canBeNegative) {
        if (c == null) return false;
        return Character.isDigit(c) || c == '.' || c == 'E' || (canBeNegative && c == '-');
    }

    private static boolean newNumber(Character c, Character prev, Expression exp, boolean empty) {
    ...
    private static boolean sameNumber(Character c, Character prev, Expression exp, boolean empty) {
        boolean canBeNegative = exp == null && empty;
        return numberChar(c, canBeNegative) && numberChar(prev, canBeNegative);
    }

    private static boolean numberEnded(Character c, Character prev, boolean empty) {
        boolean canBeNegative = !empty;
        return !numberChar(c, false) && numberChar(prev, canBeNegative);
    }

    private static boolean isHighPriorityOperator(Character c) {
        return c != null && (c == '*' || c == '/');
    }

    private static boolean isLowPriorityOperator(Character c) {
        return c != null && (c == '+' || c == '-');
    }
