...
public class MorseCodeDecoderTest {
    ...
    public void testExampleFromDescription3() throws Exception {
        assertThat(MorseCodeDecoder.decodeMorse(MorseCodeDecoder.decodeBits("10111")), is("A"));
    }

    @Test
    public void testExampleFromDescription4() throws Exception {
        assertThat(MorseCodeDecoder.decodeMorse(MorseCodeDecoder.decodeBits("1110111")), is("M"));
    }
